...
To view the component ID of a splice on the **Layout** and **Schematic** view, select **Show component IDs** from the view options menu on the **Layout** or **Schematic** views.
<br />  
